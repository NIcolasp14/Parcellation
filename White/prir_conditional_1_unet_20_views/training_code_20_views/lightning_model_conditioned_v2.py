...
class ViewConditionedLightningModel(pl.LightningModule):
    ...
    def __init__(self, num_classes=37, num_views=20, learning_rate=1e-4):
        super().__init__()
    ...
    def training_step(self, batch, batch_idx):
        ...
        view_onehots = batch['view_onehots']  # (B, 20)
    ...
    def predict_single_view(self, image, view_name):
        ...
        with torch.no_grad():
            ...
            view_onehot = torch.zeros(1, 20, device=image.device)
...
if __name__ == '__main__':
    # Test the model
    model = ViewConditionedLightningModel(num_classes=37, num_views=20)
    
    # Test forward pass
    batch_size = 4
    images = torch.randn(batch_size, 3, 800, 800)
    view_onehots = torch.zeros(batch_size, 20)
