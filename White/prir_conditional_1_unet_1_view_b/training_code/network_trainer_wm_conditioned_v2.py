...
def main():
    ...
    parser.add_argument('--num_random_views', type=int, default=4,
                       help='Number of random augmented views per mesh per epoch (1-6)')
    ...
    if not 1 <= args.num_random_views <= 6:
        raise ValueError(f"num_random_views must be 1-6, got {args.num_random_views}")
