...
==============================================
Instead of continuous camera parameters, uses discrete 6-way one-hot encoding:
- View 0: Front
- View 1: Back  
- View 2: Left
- View 3: Right
...
class ViewConditionedUNet(nn.Module):
    ...
    def __init__(self, in_channels=3, num_classes=37, num_views=6):
    ...
    def forward(self, x, view_onehot):
        ...
        Args:
            ...
            view_onehot: (B, 6) - one-hot encoded view labels
        """
        # Encode view
...
def test_model():
    ...
    model = ViewConditionedUNet(in_channels=3, num_classes=37, num_views=6)
    ...
    view_onehot = torch.zeros(batch_size, 6)
