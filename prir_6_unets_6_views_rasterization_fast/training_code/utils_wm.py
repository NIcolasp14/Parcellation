...
try:
    if USE_GPU:
        import pytorch3d
        from gpu_raycasting_pytorch3d import generate_maps_gpu
        # USE_GPU_RAYCASTING will be set by network_trainer_wm.py based on --raycasting arg
        GPU_RAYCASTING_BACKEND = "PyTorch3D"
        print("[GPU] PyTorch3D loaded - GPU raycasting AVAILABLE (will be enabled via --raycasting arg)")
except ImportError:
